...
**"Now [Model](/DenseGroupAttention/model.py) for DenseGroupAttention is ready to train on, at same time, the edit system for Simple-Word Compound Substitution is in develope"**
